...
detector = cv2.CascadeClassifier("src/models/haarcascade_frontalface_default.xml")
...
def threading ():
	os.system("python X_Axis.py left 5400")


#delta=0
def Z_left (delta):
	os.system("python Z_Axis.py left " + str(abs(delta)))
